...
if __name__ == "__main__":
    ...
    # option_maker_history_ucdc(currency_code=["EUR"], null_filler=True, infer=True, total_no_of_runs=3, run_number=0)
    # option_maker_history_ucdc(currency_code=["EUR"], null_filler=True, infer=True, total_no_of_runs=3, run_number=1)
    # option_maker_history_ucdc(currency_code=["EUR"], null_filler=True, infer=True, total_no_of_runs=3, run_number=2)
    ...
    # option_maker_history_ucdc(currency_code=["EUR"], null_filler=True, infer=True, total_no_of_runs=3, run_number=1)
    # option_maker_history_ucdc(currency_code=["EUR"], null_filler=True, infer=True, total_no_of_runs=3, run_number=2)
    # option_maker_history_ucdc(currency_code=["EUR"], null_filler=True, infer=True, total_no_of_runs=3, run_number=3)
    # option_maker_history_ucdc(currency_code=["EUR"], null_filler=True, infer=True, total_no_of_runs=3, run_number=4)
    # option_maker_history_ucdc(currency_code=["EUR"], null_filler=True, infer=True, total_no_of_runs=3, run_number=3)
    # option_maker_history_ucdc(currency_code=["EUR"], null_filler=True, infer=True, total_no_of_runs=8, run_number=3)
