...
if __name__ == "__main__":
    ...
    # option_maker_history_uno(currency_code=["USD"], option_maker=True, infer=False)
    # option_maker_history_uno(currency_code=["EUR"], option_maker=True, infer=True)
    ...
    # option_maker_history_ucdc(currency_code=["USD"], option_maker=True, infer=False)
    # option_maker_history_ucdc(currency_code=["EUR"], option_maker=True, infer=True)
