...
from model.old.model_dlpa_weekly_ohlcv import full_model
...
def main(args):
    space = {
        ...
        'Num_hidden': hp.choice('Num_hidden', [5]),
        'Learning_rate': hp.choice('Learning_rate', [1e-3, 1e-4, 1e-5]),
        'Lookback': hp.choice('Lookback', [10, 15]),
        'Num_hidden_att': hp.choice('Num_hidden_att', [7]),
        'Num_hidden_CNN': hp.choice('Num_hidden_CNN', [64, 128, 256]),
        'Dropout': hp.choice('Dropout', [0.25]),
        'batch_size': scope.int(hp.quniform('batch_size', 6, 8, 1)),  # => 2**x
    ...
    if platform.system() == 'Linux':
        args.model_path = '/home/loratech/PycharmProjects/models/dlpa_weekly_ohlcv/'
        if not os.path.exists(args.model_path):
            os.makedirs(args.model_path)
        args.plot_path = '/home/loratech/PycharmProjects/plots/dlpa_weekly_ohlcv/'
        if not os.path.exists(args.plot_path):
            os.makedirs(args.plot_path)
    else:
        args.model_path = 'C:/dlpa_master/model/dlpa_weekly_ohlcv/'
        Path(args.model_path).mkdir(parents=True, exist_ok=True)
        args.plot_path = 'C:/dlpa_master/plots/dlpa_weekly_ohlcv/'
    ...
    def hyper_fn(hypers):
        ...
        args.CNN_kernel_size = int(hypers['Num_hidden_CNN'])
