...
def model_returns(trainX1, trainY, validX1, validY, args, hypers):  # DLPM with ONLY whole period returns
    ...
    if args.train_num != 0:
        ...
        args.param_name_1 = 'wr_gru_nodes_mult'
        args.param_val_1 = wr_g_mult
        args.param_name_2 = 'wr_gru_drop'
        args.param_val_2 = wr_gru_drop
        args.param_name_3 = None
        args.param_val_3 = None
    ...
    x = Concatenate(axis=1)([x_2, x_2_2])
