...
class BlackScholes(AbstractCalculator):
    ...
    def delta_vol(self,delta, t, atmv_0, atmv_1Y, atmv_inf, term_alpha, skew_1m, skew_inf, curv_1m, curv_inf, flag):
    ...
    def find_vol(self,moneyness, expiry_days_as_fraction, atmv_0, atmv_1Y, atmv_inf, term_alpha, skew_1m, skew_inf, curv_1m,
                curv_inf, r, q):
        ...
        def strike_delta(delta):
            ...
            vol = self.delta_vol(delta, expiry_days_as_fraction, atmv_0, atmv_1Y, atmv_inf, term_alpha, skew_1m, skew_inf,
                            curv_1m, curv_inf, 0)
            K = self.delta_to_strikes(100, delta, expiry_days_as_fraction, r, q, vol)
        ...
        final_vol = self.delta_vol(final_delta, expiry_days_as_fraction, atmv_0, atmv_1Y, atmv_inf, term_alpha, skew_1m,
    ...
    def deltaUnOC(self,S, K, Bar, Reb, T, r, q, v1, v2):
        ...
        p2 = self.Up_Out_Call(S * .99, K, Bar, Reb, T, r, q, v1, v2)
    ...
    def deltaRC(self,S, K1, K2, T, r, q, v1, v2):
        ...
        p2 = self.Rev_Conv(S * .99, K1, K2, T, r, q, v1, v2)
